      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-center text-center mb-16">
          ...
          <p className="text-white/50 max-w-sm mb-6">
            27 Aralık 2025'ten beri Türkiye'nin en gelişmiş yapay zeka çözümlerini üretiyoruz.
          </p>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white/30 text-sm">© 2026 PadresStudios. Tüm hakları saklıdır.</p>
          <p className="text-white/30 text-sm flex items-center gap-2">
            Güvenlik 1Password ile sağlanmaktadır
          </p>
        </div>
      </div>
    </footer>
